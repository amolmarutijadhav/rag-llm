...
class TestAPIEndpoints:
    ...
    @pytest.mark.rag
    def test_ask_question_service_error(self, async_client):
    ...
    def test_upload_document_success(self, async_client, sample_document_response):
    ...
    def test_upload_document_unsupported_format(self, async_client):
    ...
    def test_upload_document_too_large(self, async_client):
    ...
    @pytest.mark.rag
    def test_add_text_success(self, async_client, sample_document_response):
    ...
    @pytest.mark.rag
    def test_add_text_empty_text(self, async_client):
    ...
    def test_get_stats_success(self, async_client, sample_stats_response):
    ...
    def test_get_stats_service_error(self, async_client):
    ...
    @pytest.mark.rag
    def test_clear_knowledge_base_success(self, async_client, sample_document_response):
        """Test successful knowledge base clearing."""
        with patch('src.main.rag_service') as mock_rag:
            mock_rag.clear_knowledge_base.return_value = sample_document_response
            
            response = async_client.delete("/clear")
    ...
    @pytest.mark.rag
    def test_clear_knowledge_base_service_error(self, async_client):
...
class TestAPIValidation:
    ...
    def test_ask_question_missing_fields(self, async_client):
        """Test question asking with missing required fields."""
        response = async_client.post("/ask", json={})
        assert response.status_code == 422

    def test_ask_question_invalid_top_k(self, async_client):
    ...
    def test_add_text_missing_text(self, async_client):
    ...
    def test_upload_document_missing_file(self, async_client):
        """Test document upload with missing file."""
        response = async_client.post("/upload")
        assert response.status_code == 422 